...
#import "ZYJbaseyinzhiController.h"
...
const int PILTableViewHeaderH = 0;

static long current;

@implementation ZYJbaseyinzhiController
...
- (void)loadView
{
    ...
    tableView.sectionHeaderHeight = PILTableViewHeaderH;
    
    if (iOS7) {
        tableView.contentInset = UIEdgeInsetsMake(PILTableViewHeaderH-35, 0, 0, 0);
    }
