...
@protocol diliuaDelegate <NSObject>

- (void)newMessageReceived:(NSString *)messageContent  gundan:(NSUInteger)section indexPath:(NSUInteger)row;

@end
@interface diliuViewController :  UIViewController<UIPickerViewDelegate,UIPickerViewDataSource>
...
@property (nonatomic , assign) id<diliuaDelegate> delegate;
