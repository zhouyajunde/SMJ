...
@protocol wangjibaDelegate <NSObject>

- (void)newMessageReceived:(NSString *)messageContent  gundan:(NSUInteger)section indexPath:(NSUInteger)row;

@end
@interface cnmwangjibaViewController : UIViewController<UIPickerViewDelegate,UIPickerViewDataSource>{
...
@property (nonatomic , assign) id<wangjibaDelegate> delegate;
@end
