...
@protocol diwuaDelegate <NSObject>

- (void)newMessageReceived:(NSString *)messageContent  gundan:(NSUInteger)section indexPath:(NSUInteger)row;

@end
@interface diwuViewController : UIViewController<UIPickerViewDelegate,UIPickerViewDataSource>
...
@property (nonatomic , assign) id<diwuaDelegate> delegate;
